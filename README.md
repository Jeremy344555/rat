# Remote API for testing. Расширение для интеграционных тестов по REST API

Расширение позволяет работать с базами 1С извне, используя [REST](https://ru.wikipedia.org/wiki/REST) API.
...
_[(C) BIA Technologies, LLC](http://www.bia-tech.ru)_
