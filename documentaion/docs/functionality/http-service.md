...
Ограничения и описание, что такое идентификатор для ссылок смотрите на странице [форматы данных](ФорматыДанных#идентификатор-объекта).
